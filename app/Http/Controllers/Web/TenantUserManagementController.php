    ...
    public function deactivateUser(string $tenantId, string $userId)
    {
        ...
        try {
            ...
            $this->notifications->dispatch(
                ...
                body:             'Your access to ' . ($tenant?->name ?? 'your workspace') . ' has been suspended by an admin.',
    ...
    public function removeUser(string $tenantId, string $userId)
    {
        ...
        try {
            ...
            $this->notifications->dispatch(
                ...
                body:             'Your access to ' . ($tenant?->name ?? 'your workspace') . ' has been removed by an admin.',
                notifiableType:   'tenant_admin',
                notifiableId:     (string) $userId,
                tenantId:         $tenantId,
                actionUrl:        null,
