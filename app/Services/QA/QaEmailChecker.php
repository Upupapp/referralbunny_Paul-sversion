...
class QaEmailChecker
{
    ...
    private const MAILABLES = [
        ...
        \App\Mail\ResellerDealStageMoved::class         => null,
        \App\Mail\ResellerDealAmountUpdated::class      => null,
        \App\Mail\ResellerDealExtensionApproved::class  => null,
        \App\Mail\ResellerDealDeclined::class           => null,
