...
<div class="space-y-5">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        $kpis = [
            ...
            ['label'=>'Extended Access',   'tip'=>'Tenants whose access has been manually extended by the super admin. High numbers may indicate trial conversion issues.', 'value'=>$extendedTenantsCount, 'sub'=>$totalExtensions.' total extension'.($totalExtensions === 1 ? '' : 's'), 'bg'=>'bg-orange-100','color'=>'text-orange-600','icon'=>'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'href'=>route('platform.billing')],
        ];
        @endphp
        @foreach($kpis as $kpi)
