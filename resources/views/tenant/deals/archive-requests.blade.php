                ...
                <div class="p-4 hover:bg-gray-50/40 transition-colors">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex items-center gap-1.5 shrink-0">
                            <button type="button" @click="openApprove('{{ $req->id }}', {{ json_encode($lead?->name ?? 'this deal', JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT|JSON_HEX_AMP) }})"
                            ...
                            <button type="button" @click="openClarify('{{ $req->id }}')"
                            ...
                            <button type="button" @click="openReject('{{ $req->id }}', {{ json_encode($lead?->name ?? 'this deal', JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT|JSON_HEX_AMP) }})"
