...
<div class="space-y-5"
    ...
    {{-- Link Contact Modal --}}
    <div x-show=”showLinkContact” x-cloak style=”display:none”
    ...
    {{-- ── Move Stage Modal ── --}}
    <div x-show=”showMoveStage” x-cloak style=”display:none”
         class=”fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center p-4”
    ...
    <div x-show="showReassign" x-cloak style="display:none" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
