...
<div class="space-y-5"
    ...
    <div x-show=”showLinkContact” style=”display:none”
         class=”absolute inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center p-4”
    ...
    <div x-show=”showReassign” style=”display:none” class=”absolute inset-0 bg-black/50 z-50 flex items-center justify-center p-4”>
