...
@section('topbar-actions')
    ...
    @if(app(\App\Services\Programs\ProgramNavigation::class)->allowsManualDeals($tenant->id))
...
<div class="space-y-5"
    ...
    {{-- Archive tab is served at a separate route (tenant.deals.deleted-archived).
