@extends('layouts.app')
@section('title', 'LGU IDS Deal Import')
...
@section('topbar-actions')
    <a href="{{ route('tenant.imports.lgu-ids.template', $tenant->id) }}" class="btn-secondary">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
        </svg>
        <span class="hidden sm:inline">Download Template</span>
    </a>
    <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-lgu-import'))" class="btn-primary">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@section('content')
<div x-data="{ showUpload: false }" @open-lgu-import.window="showUpload = true" class="space-y-5">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <span class="badge badge-green">LGU IDS</span>
                </div>
                <h1 class="text-[#1E1B4B] font-bold text-xl">LGU IDS Deal Import</h1>
                <p class="text-gray-400 text-sm mt-0.5">Import municipality deals with pricing validation and Referrer linking.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <div class="flex items-center gap-2.5">
                    ...
                    <h2 class="text-[#1E1B4B] font-semibold text-base">Upload LGU IDS Deal Import File</h2>
                </div>
            ...
            <form action="{{ route('tenant.imports.lgu-ids.upload', $tenant->id) }}"
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="relative"
                        ...
                        <label :class="dragging ? 'border-[#10B981] bg-emerald-50' : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'"
                            ...
                            <div class="w-12 h-12 rounded-xl flex items-center justify-center" :style="dragging ? 'background:#D1FAE5' : 'background:#F3F4F6'">
                                <svg class="w-6 h-6 transition-colors" :style="dragging ? 'color:#10B981' : 'color:#9CA3AF'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-xs text-gray-400 text-center">
                        ...
                        <a href="{{ route('tenant.imports.lgu-ids.template', $tenant->id) }}"
                           class="font-medium hover:underline" style="color: #10B981;">
