    ...
    <div class="card p-0 overflow-hidden">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
            ...
            <div x-show="totalRequiredAgreements > 0 && nonCompliantCount() > 0"
                ...
                <span x-text="nonCompliantCount() + ' referrer' + (nonCompliantCount() === 1 ? '' : 's') + ' have unsigned agreements'"></span>
            </div>
        </div>
                        ...
                        <div class="p-4 rounded-xl border transition-colors"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <template x-if="d.submission_status === 'rejected'">
                                        <div class="mt-1">
                                            <p class="text-xs text-red-500 font-medium">Rejected — referrer must resubmit</p>
