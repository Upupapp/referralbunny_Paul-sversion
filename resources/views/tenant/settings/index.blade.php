        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="card" id="contact-info">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button class="btn-secondary text-sm py-1.5 px-4">Edit</button>
                </div>
                <div class="space-y-3">
            ...
            <div class="card">
                ...
                <div class="space-y-1">
                    @foreach([
                        ...
                        ['label' => 'Notification Templates',  'href' => '#',                   'icon' => 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9'],
                        ['label' => 'API & Integrations',      'href' => '#',                   'icon' => 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4'],
                        ['label' => 'Data & Privacy',          'href' => '#',                   'icon' => 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z'],
                    ] as $section)
                    <a href="{{ $section['href'] }}"
