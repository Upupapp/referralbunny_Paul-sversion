@extends('emails.layouts.base', ['headerLabel' => 'Password Reset', 'subject' => 'Reset your password'])

@section('content')
<p class="greeting">Reset your password</p>

<p class="text">
    Hi <strong>{{ $resellerName }}</strong>, we received a request to reset your password for
    <strong>{{ $tenantName }}</strong>'s referrer portal.
</p>
