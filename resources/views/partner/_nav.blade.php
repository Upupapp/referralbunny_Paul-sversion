...
{{-- Calendar --}}
<a href="{{ route('partner.calendar') }}"
   class="pt-sidebar-link {{ request()->routeIs('partner.calendar*') ? 'active' : '' }}">
    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<a href="{{ route('partner.notifications') }}"
   class="pt-sidebar-link {{ request()->routeIs('partner.notifications') ? 'active' : '' }}">
    <span class="relative">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
