...
<head>
    ...
    <title>Reset Password — ReferralBunny.ai Referrer Portal</title>
...
<div class="card" x-data="{ show1: false, show2: false, sub: false }">
    ...
    <p style="margin:0 0 2rem;font-size:.875rem;color:#6b7280;text-align:center">Choose a strong password for your account.</p>
