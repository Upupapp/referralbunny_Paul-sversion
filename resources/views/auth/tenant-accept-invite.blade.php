...
<div class="page-wrap">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if($existingUser)
                {{-- Existing user: verify identity with existing password --}}
                <p style="font-size:.875rem;color:#6b7280;margin:0 0 1.25rem;line-height:1.6">
                    ...
                    Enter your password to verify your identity and accept this invitation.
                </p>
                <form method="POST" action="{{ route('tenant.accept-invite', $invitation->token) }}"
                      x-data="{ showPw: false, submitting: false }" @submit="submitting = true">
                    @csrf
