...
<head>
    ...
    <title>Set Up Your Partner Account — ReferralBunny.ai</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .step.active { background: #2563EB; width: 32px; }
    </style>
</head>
<body>
...
<div class="setup-page">
    <div class="setup-card">
        ...
        <div class="card-left">
            ...
            <h1 style="margin:0 0 .25rem;font-size:1.5rem;font-weight:700;color:#111827">
                Welcome{{ isset($partner) && $partner->first_name ? ', ' . $partner->first_name : '' }}!
            </h1>
            <p style="margin:0 0 .25rem;font-size:.875rem;color:#6b7280">
                You've been invited as a Partner on a referral deal. Set up your account to get started.
            </p>
        ...
        <div class="card-right">
            ...
            <div style="position:relative;z-index:1">
                ...
                <p style="margin:0 auto 2rem;font-size:.75rem;color:rgba(255,255,255,.5);line-height:1.6;max-width:200px">View the deals you've been added to and message your Referrer.</p>

                {{-- Steps on right panel --}}
                <div style="display:flex;flex-direction:column;gap:.75rem;text-align:left">
                    @foreach(['Receive invitation' => true, 'Set up account' => false, 'View your deals' => false] as $step => $done)
                    <div style="display:flex;align-items:center;gap:.75rem">
                        <div style="width:20px;height:20px;border-radius:50%;background:{{ $done ? '#2563EB' : 'rgba(255,255,255,0.15)' }};display:flex;align-items:center;justify-content:center;flex-shrink:0">
                            @if($done)
