...
<div class="card" x-data="{ show1: false, show2: false, sub: false }">
    ...
    <form method="POST" action="{{ route('partner.reset-password.post') }}" @submit="sub=true">
        ...
        <div style="margin-bottom:1rem">
            <label for="password" class="field-label">New Password <span style="font-size:.75rem;color:#9ca3af;font-weight:400">— min. 8 characters</span></label>
            <div class="pw-wrap">
                <input id="password" name="password" :type="show1 ? 'text' : 'password'" required minlength="8" class="field-input" style="padding-right:2.75rem" placeholder="At least 8 characters">
        ...
        <div style="margin-bottom:1.5rem">
            ...
            <div class="pw-wrap">
                <input id="password_confirmation" name="password_confirmation" :type="show2 ? 'text' : 'password'" required class="field-input" style="padding-right:2.75rem" placeholder="Repeat your password">
    ...
    <p style="text-align:center;margin-top:1.25rem;font-size:.8125rem;color:#6b7280">
        <a href="{{ route('login') }}" style="color:#2563EB;text-decoration:none">← Back to Sign In</a>
    </p>
</div>
</body>
</html>
