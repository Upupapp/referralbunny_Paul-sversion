...
<head>
    ...
    <title>Sign In — ReferralBunny.ai Referrer Portal</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .forgot { display: block; text-align: right; font-size: .75rem; color: #0D9488; text-decoration: none; margin-top: .375rem; }
        ...
        .help-text a { color: #0D9488; text-decoration: none; }
    </style>
</head>
<body>
...
<div class="login-page">
    <div class="login-card">
        ...
        <div class="card-left">
            ...
            <form method="POST" action="{{ route('reseller.login.post') }}" class="form-wrap">
                @csrf
                ...
                <div style="display:flex;align-items:flex-start;gap:.625rem;margin:.875rem 0 .75rem">
                    <input type="checkbox" id="remember_reseller" name="remember"
                           style="margin-top:2px;width:16px;height:16px;accent-color:#0D9488;cursor:pointer;flex-shrink:0"
                           aria-describedby="remember_reseller_hint">
                    <div>
                        <label for="remember_reseller" style="font-size:.8125rem;font-weight:500;color:#374151;cursor:pointer;display:block">
                            Keep me signed in on this device
                        </label>
                        <p id="remember_reseller_hint" style="margin:.125rem 0 0;font-size:.6875rem;color:#9CA3AF;line-height:1.4">
        ...
        <div class="card-right">
            ...
            <div style="position:relative;z-index:1">
                ...
                <h2 style="margin:0 0 .5rem;font-size:1.125rem;font-weight:700;color:#fff;line-height:1.4">Submit deals.<br>Earn commissions.</h2>
                <p style="margin:0 auto;font-size:.75rem;color:rgba(255,255,255,.5);line-height:1.6;max-width:180px">Track every referral, stage by stage.</p>
            </div>
        </div>
