        ...
        <div class="card-left">
            ...
            <form method="POST" action="{{ route('tenant.login.post') }}" class="form-wrap">
                ...
                <div style="margin-bottom:.25rem">
                    ...
                    <span class="forgot" style="cursor:default;color:#9ca3af" title="Contact your workspace administrator to reset your password.">Forgot password? Contact your admin.</span>
                </div>
