...
<div x-data="rsDealData()" class="space-y-5 max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6">
        ...
        <div class="mt-5 pt-4 border-t border-gray-100">
            ...
            {{-- ── Desktop: all primary actions in one flex-wrap row ── --}}
            <div class="hidden sm:flex flex-wrap items-center gap-2 mb-3">

                {{-- Add Note — teal primary --}}
                <button @click="showAddNote = true"
                        class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-white transition-all hover:shadow-md active:scale-95 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-1"
                ...
                {{-- Update Amount — purple soft --}}
                @if(!in_array($lead->commission_status ?? 'pending', ['locked','paid']))
                <button @click="showUpdateAmount = true"
                        class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-[#7B61FF] bg-purple-50 hover:bg-purple-100 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-1">
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    Update Amount
                </button>
                @else
                <span class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-gray-400 bg-gray-100 cursor-not-allowed"
                ...
                {{-- Move Stage — blue soft --}}
                @if(!$pendingStageMoveRequest && $lead->stage !== 'paid')
                <button @click="showMoveStage = true"
                        class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-1">
                ...
                <button @click="showAddPartner = true"
                        class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1">
                ...
                {{-- Request Extension — amber — backend connected --}}
                <button @click="showExtension = true"
                        class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-amber-700 bg-amber-50 hover:bg-amber-100 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-1">
